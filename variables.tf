...
variable "managed_master_security_group_name" {
  type        = string
  default     = "managed-emr-master-sg"
...
variable "master_security_group_name" {
  type        = string
  default     = "emr-master-sg"
  description = "The name of the  managed security group that will be used for EMR master node. "
}

variable "managed_slave_security_group_name" {
  type        = string
  default     = "managed-slave-emr-sg"
  description = "The name of the  managed security group that will be used for EMR master node. "
}

variable "slave_security_group_name" {
  type        = string
  default     = "emr-slave-sg"
  description = "The name of the  managed security group that will be used for EMR master node. "
}
